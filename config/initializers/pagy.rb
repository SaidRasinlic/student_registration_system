...
# Pagy::DEFAULT[:link_prev] = { text: 'Custom Previous' }
# Pagy::DEFAULT[:prev] = '&laquo; Custom Previous'
# Pagy::DEFAULT[:pagy_prev] = 'Previous'

# Pagy::DEFAULT[:anchor_string] = 'Hell'
# Pagy::DEFAULT[:prev] = 'Hell'
# Pagy::DEFAULT[:pagy_next_a] = 'xDDD'
# Extras
